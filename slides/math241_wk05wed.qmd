...
[Math 241 <br> Week 5 \| Spring 2026]{.custom-subtitle}
:::
:::::
...
But what happens to the geometry?
...
- In `trails_combined`, you'll notice that the **trails that combined are now listed a `MULTILINESTRING`**

- this is how `sf` can "combine" multiple geometries into the same row of data.
...
- Think: **spatially indexed matrix**. Each cell..
    - is a predefined size square
    - is the same size as the other cells
...
90m x 90m elevation data in M333 "ecoprovince"
...
- When the data are available, we get the same result as the package has! 
...
- There is so much more we can do with rasters (and all the spatial data types we have learned about)! 
