...
[Math 241 <br> Week 2 \| Fall 2025]{.custom-subtitle}
:::
:::::
...
* `Quarto` documents allow us to include our `R` code, output, and narrative in the same place. 
    ...
    + Even if you don't showcase the `R` code in the output file, it is contained in the `Rmd` file.
...
And there are lots more ways to annotate your graph (shaded regions, spike lines...).  
