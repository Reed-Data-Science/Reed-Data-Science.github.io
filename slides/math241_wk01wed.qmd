...
ggplot(data = math241_form, mapping = aes(x = tidyr)) +
  geom_bar(fill = "#A71F69", color = "white") +
  labs(x = "tidyr Experience",
...
## Consideration: [Try to have a high data-ink ratio.](https://vizdata.org/slides/01/01-layers-1.html#/section)
...
## Consideration: [Make important comparisons easy.](https://serialmentor.com/dataviz/visualizing-proportions.html)
...
## Consideration: [Make important comparisons easy.](https://serialmentor.com/dataviz/visualizing-proportions.html) {.smaller}
...
p2 <- ggplot(data = math241_form, mapping = aes(x = ggplot2, fill = dplyr)) +
  geom_bar(color = "white", linewidth = 2) +
  labs(x = "ggplot2 Experience",
       y = "Number of students") +
  coord_flip() +
  scale_fill_brewer(type = "seq", palette = 1)  +
