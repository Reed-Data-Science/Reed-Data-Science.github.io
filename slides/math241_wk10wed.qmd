...
- [Hannah Ritchie's blog post](https://hannahritchie.substack.com/p/ai-footprint-august-2025)

- [Simon Couch's blog post](https://www.simonpcouch.com/blog/2026-01-20-cc-impact/)

:::

- Good for understanding environmental concerns. **Algorithmic bias** and **fair use** on the other hand...
...
- At it's most simple form... 

talk about how it is a big matrix of weights

big matrix --> too big for your computer (local llm's are cool but need a good MBP)

hosted on someone else's server --> need to have an API key to access that server

querying a LLM is an "expensive computation": matrix algebra on large matrix

computing takes electricity --> you pay for the electricity

or, you give your data to be trained on and get some stuff for free
...
# AI from a Data Scientist's Perspective
...
- [Cerebras](https://www.cerebras.ai/) provides "free" access to some LLMs they host, but you still need to get an API key.
    ...
    - Models will likely be trained on the data you give it at this free tier. 
...
- "qwen-3-235b-a22b-instruct-2507" has relatively relaxed rate limits, allowing 30 requests per minute, and 14,400 requests per day.
...
<!-- Now my chat bot can delete files on my computer -->
...
<!-- Now, deleting files is a pretty small part of doing data science / developing software... -->
