...
### part c (OPTIONAL, for now): Connect git, GitHub and RStudio (or Positron)

We will spend some time in class going through these steps in the coming weeks, but I wanted to give you the option to try it on your own if you'd like to. If you're feeling up for it, I'd suggest trying this step. These instructions are based on pieces of [Happy git with R](https://happygitwithr.com/), in particular chapters 6, 7, and 9. 
